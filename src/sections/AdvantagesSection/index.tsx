  ...
  return (
    <div className="caret-transparent w-full">
      <div className="relative bg-black caret-transparent min-h-[1400px] text-center align-middle w-full overflow-hidden md:min-h-[900px] max-w-[1920px] mx-auto">
        <div 
          className="fixed bg-[url('https://optim.tildacdn.com/tild3262-6663-4137-b764-373837323766/-/format/webp/-1_1.jpg.webp')] bg-no-repeat bg-cover caret-transparent h-full align-middle w-full bg-center inset-0 -z-10"
        ></div>
        ...
        <div className="caret-transparent relative z-[2]">
