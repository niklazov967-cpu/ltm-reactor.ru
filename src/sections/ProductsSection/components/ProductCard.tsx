...
export const ProductCard = (props: ProductCardProps) => {
  return (
    <div className="text-[0px] box-border caret-transparent float-none max-w-full text-left align-top w-full mb-5 mx-0 px-2.5 md:text-base md:box-content md:float-left md:max-w-[360px] md:align-baseline md:mb-0 md:mx-5 md:px-0 transition-all duration-300 hover:-translate-y-1">
      <div className="text-[0px] bg-white caret-transparent overflow-hidden rounded-[30px] md:text-base transition-all duration-300 hover:shadow-[0_10px_40px_rgba(0,0,0,0.15)]">
